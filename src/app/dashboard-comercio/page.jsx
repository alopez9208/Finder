      ...
      <div className="mb-6 ml-32">
        ...
        <div className="bg-[#fff] p-6 h-40 w-full max-w-5xl rounded-2xl flex items-center gap-8 mt-8">
          <div className="flex-1">
            <h2 className="text-3xl font-semibold text-gray-800">Hola, Andrés</h2>
            <p className="text-gray-800 mt-1 text-xl">¿Listo para optimizar la gestión de los clientes?</p>
          </div>
