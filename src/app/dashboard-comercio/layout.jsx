        ...
        <div>
          ...
          <nav className="flex flex-col gap-1 w-full">
            <button
              ...
              className={`flex items-center gap-1 rounded p-1 cursor-pointer mb-4 justify-center ${isActive("/dashboard-comercio")}`}>
            ...
            <button
              onClick={() => router.push("/dashboard-comercio/user-data")}
              className={`flex items-center gap-1 rounded pl-4 p-1 cursor-pointer ${isActive("/dashboard-comercio/user-data")}`}>
              <FaUserCog className="text-2xl" />
              <span className="text-lg">Usuarios</span>
            </button>

            <button
              onClick={() => router.push("/dashboard-comercio/user-data/statuses")}
              className={`flex items-center justify-center gap-1 pr-16 rounded p-1 cursor-pointer ${isActive("/dashboard-comercio/user-data/statuses")}`}>
              <MdAdminPanelSettings className="text-2xl" />
              <span className="text-lg">Estados</span>
            </button>

            <button
              onClick={() => router.push("/dashboard-comercio/user-data/roles")}
              className={`flex items-center justify-center gap-1 pr-20 rounded p-1 cursor-pointer ${isActive("/dashboard-comercio/user-data/roles")}`}>
            ...
            <button
              onClick={() => router.push("/dashboard-comercio/client-data/departamentos")}
              className={`flex items-center gap-1 rounded pl-4 p-1 cursor-pointer ${isActive("/dashboard-comercio/client-data/departamentos")}`}>
              <BiWorld className="text-2xl" />
              <span className="text-lg">Departamentos</span>
            </button>

            <button
              onClick={() => router.push("/dashboard-comercio/client-data/municipios")}
              className={`flex items-center gap-1 rounded pl-4 p-1 cursor-pointer ${isActive("/dashboard-comercio/client-data/municipios")}`}>
            ...
            <button
              ...
              className={`flex items-center gap-1 rounded pl-4 p-1 mt-1 cursor-pointer ${isActive("/dashboard-comercio/products")}`}>
              <FaShoppingCart className="text-2xl" />
              <span className="text-lg">Productos</span>
            </button>
            <button
              onClick={() => router.push("/dashboard-comercio/empresas")}
              className={`flex items-center gap-1 rounded pl-4 p-1 mt-1 cursor-pointer ${isActive("/dashboard-comercio/empresas")}`}>
            ...
            <button
              onClick={() => router.push("/dashboard-comercio/transporters")}
              className={`flex items-center gap-1 rounded pl-4 p-1 mt-1 cursor-pointer ${isActive("/dashboard-comercio/transporters")}`}>
